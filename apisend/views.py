...
class send(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            text = f' سلام جناب {sender.last_name} عزیزوقت بخیر به کافی نت «تاوا پی سی» خوش اومدید برای دریافت آخرین خبرها و ثبت نام ها روی لینک زیر کلیک کنین 
            :https://eitaa.com/tavapc_cofeenet'
